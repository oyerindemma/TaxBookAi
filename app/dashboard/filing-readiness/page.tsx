    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <ReadinessStatCard
          ...
          value={String(readiness.totals.openTransactions)}
          description="Transactions still inside the live review workflow for this filing window."
        />
        <ReadinessStatCard
          label="Tax records in scope"
          value={String(readiness.totals.taxRecordsInScope)}
          description="Tax records contributing evidence and filing support checks in the current window."
        />
        <ReadinessStatCard
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                The score runs from 0 to 100 and is reduced by blocker counts across the active
                filing workflow.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
