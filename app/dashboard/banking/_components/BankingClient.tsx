      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              CSV preview, row validation, and duplicate-safe import live in the reconciliation
              module so the transaction engine stays focused on review and management.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {imports.length === 0 ? (
              <div className="rounded-md border border-dashed px-4 py-5 text-sm text-muted-foreground">
                No statement imports yet. Open the importer to preview a CSV, map columns, and
                bring bank rows into this workspace.
              </div>
            ) : (
