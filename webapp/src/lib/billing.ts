...
export const PLAN_CONFIG: Record<SubscriptionPlan, PlanConfig> = {
  STARTER: {
    ...
    includes: [
      "Manual bookkeeping",
      "Transaction capture and review",
      "VAT summary",
      "Basic reports",
    ],
    lockedFeatures: [
...
export const FEATURE_CONFIG: Record<PlanFeature, FeatureConfig> = {
  ...
  BANKING: {
    id: "BANKING",
    name: "Transaction capture and review",
    description: "Add transactions, import statements, review activity, and prepare records for tax estimates.",
