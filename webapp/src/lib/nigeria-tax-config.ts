import { getNigeriaVatRate, NIGERIA_TAX_RULES_VERSION } from "@/lib/nigeria-tax-rules";
...
export const NIGERIA_TAX_CONFIG = {
  ...
  authority: "FIRS/NRS",
  rulesVersion: NIGERIA_TAX_RULES_VERSION,
  exportSchemaVersion: 1,
  vat: {
    standardRate: getNigeriaVatRate("2026-04-28"),
