        ...
        <Card>
          ...
          <CardContent>
            {snapshot.openPeriods.length === 0 ? (
              <div className="space-y-3 rounded-lg border border-dashed px-4 py-8 text-sm text-muted-foreground">
                <p>No open tax periods yet.</p>
                <p>Generate a monthly or quarterly computation above to start review.</p>
              </div>
            ) : (
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {snapshot.recentPeriods.length === 0 ? (
              <div className="space-y-3 rounded-lg border border-dashed px-4 py-8 text-sm text-muted-foreground">
                <p>No tax periods generated yet.</p>
                <p>Create your first VAT or WHT computation above.</p>
              </div>
            ) : (
