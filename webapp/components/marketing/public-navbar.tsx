...
export function PublicNavbar() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-primary/92 shadow-[0_10px_34px_rgba(2,8,23,0.28)] backdrop-blur-xl supports-[backdrop-filter]:bg-primary/78">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:py-4">
          <Link href="/" className="flex min-w-0 items-center gap-3">
            <div className="flex size-9 shrink-0 items-center justify-center rounded-2xl bg-gradient-primary text-sm font-semibold text-white shadow-glow sm:size-10">
              TB
            </div>
            <div className="min-w-0 space-y-0.5">
              ...
              <p className="hidden truncate text-xs text-white/60 sm:block">{MARKETING_TAGLINE}</p>
            </div>
          </Link>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[min(90vw,320px)] border-white/10 bg-primary text-white">
      ...
      <div aria-hidden className="h-[65px] shrink-0 sm:h-[73px]" />
    </>
  );
}
